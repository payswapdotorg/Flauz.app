...
3. Multi-folder local projects — in-baseline official capability (26.715)
   wholly absent (single-path project model) → **WO-P1-003** (open; next
   implementation per operator directive 2026-09-17, sequenced after
   WO-LAB-001).
